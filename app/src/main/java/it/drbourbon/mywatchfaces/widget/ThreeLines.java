...
import it.drbourbon.mywatchfaces.R;
...
public class ThreeLines extends DigitalClockWidget {
    ...
    private SlptViewComponent buildDateView(Service service, int x, int y) {
        ...
        var27.setImagePicture(Util.assetToBytes(service, "slash-62-red.png"));
        ...
        var21.setStringPictureArrayForAll(this.digitalNums);
        var21.setStart(x, y);
    ...
    private SlptViewComponent buildTimeView(Service service, int x, int y) {
        ...
        var27.setImagePicture(Util.assetToBytes(service, "dots-62.png"));
    ...
    public List<SlptViewComponent> buildSlptViewComponent(Service service) {
        ...
        bg.setImagePicture(Util.assetToBytes(service, "black.png"));
        retVal.add(bg);
